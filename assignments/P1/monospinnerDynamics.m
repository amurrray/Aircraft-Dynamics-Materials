...
% rotation and attitudeInfluence
R = rotation321(o);
...
f_b = [0; 0; -rotorThrust] + R * [0; 0; m*g]; % sum of all forces acting on the aircraft

v_dot = (f_b/m) - cross(omega_B, v_E_B); 


G_B = [0; 0; -rotorTorque;] + cross( [l; 0; 0] , [0; 0; -rotorThrust]);


omega_B_dot = I_B^(-1) * (G_B - cross(omega_B, (I_B * omega_B) ) );
